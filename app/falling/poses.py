...
class BioloidGPPoses:
    ...
    def stand_pose(self):
        ...
        q[0] = -0.50 * math.pi
        q[4] = 0.231 + 1.0 / math.sqrt(2) * (10.0 / 9.0)
        q[5] = q[4]
        return q
    ...
    def stepping2_vel(self):
        return np.array([3.19884897, 0.28369571, 0.18538221, 0.03455344,
                         -0.89728113, 0.07490172, -0.30123542, 0.33764931,
                         -0.20052682, 0.47040108, 0.5076734, -0.56221476,
                         -0.44727244, -0.56073295, -1.19884757, -1.60686947,
                         0.37782936, -1.83634955, 1.4344175, 1.94303486,
